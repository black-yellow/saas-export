        ...
        function deleteById() {
            ...
            if (id) {
                if (confirm("你确认要删除此条记录吗？")) {
                    location.href = "${ctx}/company/delete/" + id;
                }
            } else {
                                ...
                                <div class="form-group form-inline">
                                    <div class="btn-group">
                                        <button type="button" class="btn btn-default" title="新建"
                                                onclick='location.href="${ctx}/company/toAdd"'><i
                                ...
                                <tbody>
                                    <c:forEach items="${companyList}" var="item">
                                        <tr>
                                            ...
                                            <td>${item.name}</td>
                                            <td><fmt:formatDate value="${item.expirationDate}" pattern="yyyy-MM-dd HH:mm:ss"></fmt:formatDate> </td>
                                            <td>${item.city}</td>
                                            <td>${item.address}</td>
                                            ...
                                            <td class="text-center">
                                                <button type="button" class="btn bg-olive btn-xs"
                                                        onclick='location.href="${ctx}/company/toUpdate?id=${item.id}"'>
                                                    编辑
                                                </button>
                                            </td>
                                        </tr>
